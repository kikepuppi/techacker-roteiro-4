...
Este é um projeto acadêmico. Sinta-se livre para fazer melhorias!

---

## Licença

Projeto educacional - Insper 2026

---

## Suporte

Para problemas ou dúvidas, consulte a documentação da MDN sobre WebExtensions:
- https://developer.mozilla.org/pt-BR/docs/Mozilla/Add-ons/WebExtensions/

---

Desenvolvido como parte do curso de Segurança de Sistemas - Insper